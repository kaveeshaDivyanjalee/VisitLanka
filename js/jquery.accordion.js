!(function (e) {
    ...
    return (
      n.each(function () {
        ...
        o(n, s),
          ...
          "dblclick" == s.bind &&
            n.bind("dblclick", function (e) {
              e.preventDefault(), c(n, s);
            }),
          (id = n.attr("id")),
          t(s) && l(s)
            ? !1 === a(id, s)
              ? (n.addClass(s.cssClose), s.loadClose(n, s))
              : (n.addClass(s.cssOpen), s.loadOpen(n, s), (u = id))
            : id != s.defaultOpen
            ? (n.addClass(s.cssClose), s.loadClose(n, s))
            : (n.addClass(s.cssOpen), s.loadOpen(n, s), (u = id));
      }),
      u.length > 0 && t(s) ? d(u, s) : d("", s),
      n
    );
  }
  ...
  function i(n) {
    (opened = e(document).find("." + n.cssOpen)),
      e.each(opened, function () {
        e(this).addClass(n.cssClose).removeClass(n.cssOpen),
          n.animateClose(e(this), n);
      });
  }

  function s(e, n) {
    i(n),
      e.removeClass(n.cssClose).addClass(n.cssOpen),
      n.animateOpen(e, n),
      t(n) && ((id = e.attr("id")), d(id, n));
  }

  function c(e, n) {
    return e.hasClass(n.cssOpen)
      ? (i(n), t(n) && d("", n), !1)
      : (i(n), s(e, n), !1);
  }
  ...
  function a(n, o) {
    return (
      !!t(o) &&
      !!l(o) &&
      ((cookie = unescape(e.cookie(o.cookieName))), cookie == n)
    );
  }
